...
const ProductScreen = () => {
  ...
  return (
    <div className="w-full h-full bg-white shadow-lg rounded-xl p-6 flex flex-col justify-center items-center">
      {loading ? (
        <h2>Loading...</h2>
      ) : error ? (
        <h2>{error}</h2>
        ...
        <>
          <div className=" flex justify-center mb-4 md:mb-0">
            <img className='w-auto  h-auto rounded-3xl' src={product.imageUrl.url} alt={product.name} />
          </div>
          <div className="flex flex-col justify-center md:ml-6 lg:pl-6">
            ...
            <div className='w-full flex justify-center'>
              <button className=' w-40  py-2 px-4 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none' type="button" onClick={addToCartHandler}>
                Add To Cart
              </button>
            </div>
          </div>
